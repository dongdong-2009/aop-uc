...
//			}
	...
	private ModelAndView listTenant(HttpServletRequest request,HttpServletResponse response)throws Exception{
		QueryFilter queryFilter = new QueryFilter(request, "InfoItem");
		List<SysOrgInfo> list = sysOrgInfoService.getAll(queryFilter);
