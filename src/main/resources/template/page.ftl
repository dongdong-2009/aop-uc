...
<div class="panel-page">		
	<div class="l-panel-bbar-inner">
		...
		<div class="l-bar-group">
			<span class="pcontrol"> 
				<input size="4" value="${pageBean.currentPage}" style="width: 20px;text-align:center" maxlength="3" class="inputText_normal" type="text" id="navNum${tableIdCode}" name="navNum"/>/ <span>${pageBean.totalPage}</span>
			</span>
		</div>
		<div class="l-bar-separator"></div>
		<div class="l-bar-group">
