...
if (typeof jQuery != 'undefined') { 
	...
	$(document).ready(function()
	{
		...
		$("div.show-code-block").html('<div class="show-code-close-icon"><a href="javascript:void(0)"><img src="'+CTX+'/FushionCharts/images/close.gif" /></a></div><span id="titlebar">XML</span><div class="clear"></div><pre class="prettyprint"></pre><div class="show-code-close-btn"><a class="qua qua-button" href="javascript:void(0)"><span>Close</span></a></div>');
