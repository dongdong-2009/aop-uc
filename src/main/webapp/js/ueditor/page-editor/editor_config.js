    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'print', 'preview', 'searchreplace','help','|','customdisplay','systablemanage']
        ]
        ...
        ,labelMap:{
            ...
            'lineheight':'行间距', 'customstyle':'自定义标题','autotypeset': '自动排版','webapp':'百度应用','customdisplay':'自定义数据组件',
            'systablemanage':'自定义表管理'
        }
...
//            },
            ...
            {
                label:'删除',
                cmdName:'deletecustomdisplay',
            },
            {
                label:'编辑',
                cmdName:'customdisplay',
                value:'edit'
            },
           ]
