    ...
    font-size: 14px;}
	 ...
	 <body>
        ...
        <div class="changeMobile_title">
		     <div class="changeMobile">验证邮箱</div>
		</div>
		...
		<div class="changeMobile_intro">
		     <form id="loginForm" method="post" >
				    ...
				    <label class="findPwd_mainCon_tit">电子邮箱：</label>
				    ...
				    <input type="text" id="email" name="email" class="findPwd_mainCon_con" value="${user.email }" />
				    </c:if>
				    ...
				    <!-- <input type="text" id="email" name="email" maxlength="60" class="findPwd_mainCon_con" required email="true" data-msg-email="请输入正确的email地址" /> -->
				    <div style="font-size:14px;margin-left: 180px;margin-top: 10px;"><img src="${ctx}/pages/images/warn.png" style="margin: -10px 0px;"></img>请输入常用电子邮箱，以便开展业务</div>
				  </div> 
				 <div class="form-list1">
				...
				success : function(resultMessage) {
					if(resultMessage && resultMessage.indexOf("成功") > 0){
						layer.alert("邮箱验证码校验成功",function(){
							window.location.href="${ctx}/security/validatingEmailSuccess.ht?email="+email;
						});
						//window.location.href="${ctx}/security/validatingEmailSuccess.ht?email="+email;
					}else{
