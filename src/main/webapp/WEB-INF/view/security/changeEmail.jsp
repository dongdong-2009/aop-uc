...
<script language="JavaScript" type="text/javascript" src="${ctx}/js/jquery/jquery-1.8.3.min.js"></script>
	 ...
	 <body>
		...
		<div class="changeMobile_intro">
		     <form id="loginForm"  method="post" >
      			  ...
      			  <div class="form-list1">
				    <label class="findPwd_mainCon_tit">原邮箱：</label>
				    <input type="text" id="email" name="email" class="findPwd_mainCon_con" disabled="true"  value="${user.email }"/>
				  </div> 
				 <div class="form-list1">
				...
				success : function(resultMessage) {
					if(resultMessage && resultMessage.indexOf("成功") > 0){
						layer.alert("邮箱验证码校验成功",function(){
							window.location.href="${ctx}/security/changeEmailStep2.ht";
						});
						//window.location.href="${ctx}/security/changeEmailStep2.ht";
					}else{
