 ...
 body {
	 ...
	 <body>
        ...
        <div class="changeMobile_title">
	 	...
	 	<div style="width:400px;float:left;font-size:14px;margin-top: 20px; margin-left: 180px;">
		 	<img src="${ctx}/pages/images/warn.png" style="margin: -10px 0px;"></img>我们不会泄露您的手机信息
		</div>
		<div class="changeMobile_intro">
		     <form id="loginForm" method="post" >
      			  <div class="form-list1">
				    <label class="findPwd_mainCon_tit">新手机号码：</label>
				   <%--  <input type="text" id="mobile" name="mobile" maxlength="11" class="findPwd_mainCon_con" required mobile="true" data-msg-mobile="请输入正确手机号码"  data-rule-remote="${ctx}/user/checkPhoneRepeat.ht" data-msg-remote="该手机号已被注册"/> --%>
				    <input type="text" id="mobile" name="mobile" maxlength="11" class="findPwd_mainCon_con" required mobile="true" data-msg-mobile="请输入正确手机号码" />
				  </div> 
				 <div class="form-list1">
				  ...
				  <div class="form-list" > 
				   ...
				   <div class="form-list">
				 	<div style="width:450px;float:left;font-size:14px;margin-left:70px;color:blue;">没收到短信验证码</div>
				 	<div style="height:5px;clear:both"></div>	
				 	<div style="width:370px;float:left;font-size:14px;margin-left:70px;color:blue;">
	...
	<script type="text/javascript">
				...
				success : function(resultMessage) {
					if(resultMessage && resultMessage.indexOf("成功") > 0){
						layer.alert("手机验证码校验成功",function(){
							window.location.href="${ctx}/security/changeMobileStep3.ht?mobile="+mobile;
						});
						//window.location.href="${ctx}/security/changeMobileStep3.ht?mobile="+mobile;
					}else{
		...
		function clickReturn(){
			window.location.href="${ctx}/security/changeMobile.ht";
		}		
