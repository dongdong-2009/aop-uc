...
<html>
  <head>
    <meta charset="utf-8">
    <title>UCenter数据中心</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="author" content="Bluth Company">
    <link rel="shortcut icon" href="/js/assets/ico/favicon.html">
    ...
    <link href="/js/assets/css/alertify.css" rel="stylesheet">
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          <div class="logo"> 
            <img src="/js/assets/img/logo.png" alt="Realm Admin Template">
          </div>
    ...
    <div class="container-fluid">
      ...
      <div class="sidebar-nav nav-collapse collapse">
        <div class="user_side clearfix">
          <img src="/js/assets/img/ucadmin.jpg" alt="Odinn god of Thunder">
          <h5>平台管理员</h5>
          <a href="http://10.142.15.235:1027">UCenter</a>        
        </div>
        <div class="accordion" id="accordion2">
          ...
          <div class="accordion-group">
            <div class="accordion-heading">
              <a class="accordion-toggle b_F6F1A2" href="tasks.html"><i class="icon-tasks"></i> <span>企业</span></a>
            </div>
          </div>
          <div class="accordion-group">
            <div class="accordion-heading">
              <a class="accordion-toggle b_C1F8A9" href="analytics.html"><i class="icon-bar-chart"></i> <span>登录</span></a>
            </div>
          </div> 
          <div class="accordion-group">
            <div class="accordion-heading">
              <a class="accordion-toggle b_9FDDF6" href="tickets.html"><i class="icon-bullhorn"></i> <span>接口</span></a>
            </div>
          </div> 
          <div class="accordion-group">
            <div class="accordion-heading">
              <a class="accordion-toggle b_F5C294" href="users.html"><i class="icon-user"></i> <span>用户</span></a>
            </div>
          </div>      
        </div>
      </div>
...
<!-- 
        ...
        <div class="row-fluid">
          ...
          <div class="widget span8">
            <div class="widget-header">
              ...
              <h5>近三月增长</h5>
              <div class="widget-buttons">
                  <button class="btn btn-info btn-small" type="button"><i class="icon-plus"></i> 更多</button>
                  <a href="javascript:void(0)" class="collapse" data-collapsed="false"><i data-title="Collapse" class="icon-chevron-up"></i></a>
              </div>
            </div>
            <div class="widget-body clearfix">
              ...
              <div class="widget-body clearfix" style="height: 170px;" id="widget-tasks">
                <div class="widget-tasks-statistics">
                  <div class="userstats clearfix" style="margin-top: 25px;">
                      ...
                      <img src="/js/assets/img/avatars/07.jpg" class="image">
                      <div class="widget">
                  ...
                  <div class="userstats clearfix">
                      <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                      <img src="/js/assets/img/avatars/08.jpg" class="image">
                      <div class="widget">
                  ...
                  <div class="userstats clearfix">
                      <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                      <img src="/js/assets/img/avatars/09.jpg" class="image">
                      <div class="widget">
                  ...
                  <div class="userstats clearfix">
                      <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                      <img src="/js/assets/img/avatars/10.jpg" class="image">
                      <div class="widget">
                  ...
                  <div class="userstats clearfix">
                      <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                      <img src="/js/assets/img/avatars/11.jpg" class="image">
                      <div class="widget">
                  ...
                  <div class="userstats clearfix">
                      <a href="javascript:void(0)" data-toggle="modal" data-target="#task_modal">
                      <img src="/js/assets/img/avatars/12.jpg" class="image">
                      <div class="widget">
                ...
                <ul>
                  <li class="priority-high">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                      <img src="/js/assets/img/avatars/02.jpg" class="avatar"/>
                  ...
                  <li class="priority-medium">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                      <img src="/js/assets/img/avatars/03.jpg" class="avatar"/>
                      <h5>Login</h5>
                  ...
                  <li class="priority-medium">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                      <img src="/js/assets/img/avatars/04.jpg" class="avatar"/>
                      <h5>Problem</h5>
                  ...
                  <li class="priority-medium">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                      <img src="/js/assets/img/avatars/01.jpg" class="avatar"/>
                      <h5>Problem</h5>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                      <div class="date">Monday</div>
                    </a>
                  ...
                  <li class="priority-medium">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                      <img src="/js/assets/img/avatars/13.jpg" class="avatar"/>
                      <h5>A Problem</h5>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                      <div class="date">Monday</div>
                    </a>
                  ...
                  <li class="priority-low">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                      <img src="/js/assets/img/avatars/12.jpg" class="avatar"/>
                      <h5>Big Problem</h5>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                  ...
                  <li class="priority-low">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                      <img src="/js/assets/img/avatars/08.jpg" class="avatar"/>
                      <h5>Big Problem</h5>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                      <div class="date">Yesterday</div>
                    </a>
                  ...
                  <li class="priority-low">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                      <img src="/js/assets/img/avatars/10.jpg" class="avatar"/>
                      <h5>Big Problem</h5>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                      <div class="date">Yesterday</div>
                    </a>
                  ...
                  <li class="priority-low">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#example_modal">
                      <img src="/js/assets/img/avatars/11.jpg" class="avatar"/>
                      <h5>Big Problem</h5>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing...</p>
                      <div class="date">Yesterday</div>
                    </a>
            ...
            <div class="widget-body" style="height:310px;overflow:hidden">
              <div class="widget-comments clearfix slimscroll">
                <ul>
                  ...
                  <li>
                    <img src="/js/assets/img/avatars/05.jpg" class="avatar"/>
                    <div class="comment-bubble">
                  ...
                  <li>
                    <img src="/js/assets/img/avatars/06.jpg" class="avatar"/>
                    <div class="comment-bubble">
    ...
    <div id="task_modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <div class="clearfix">
          <img src="/js/assets/img/avatars/11.jpg" class="img-circle" style="float: left; width: 65px; margin-right: 20px;">
    ...
    <script type="text/javascript" src="/js/assets/js/jquery-ui.min.js"></script>
    <script type="text/javascript" src="/js/assets/js/raphael-min.js"></script>
    <script type="text/javascript" src="/js/assets/js/bootstrap.js"></script>
    <script type="text/javascript" src='/js/assets/js/sparkline.js'></script>
    <script type="text/javascript" src='/js/assets/js/morris.min.js'></script>
    <script type="text/javascript" src="/js/assets/js/jquery.dataTables.min.js"></script>   
    <script type="text/javascript" src="/js/assets/js/jquery.masonry.min.js"></script>   
    <script type="text/javascript" src="/js/assets/js/jquery.imagesloaded.min.js"></script>   
    <script type="text/javascript" src="/js/assets/js/jquery.facybox.js"></script>   
    <script type="text/javascript" src="/js/assets/js/jquery.alertify.min.js"></script> 
    <script type="text/javascript" src="/js/assets/js/jquery.knob.js"></script>
    <script type='text/javascript' src='/js/assets/js/fullcalendar.min.js'></script>
    <script type='text/javascript' src='/js/assets/js/jquery.gritter.min.js'></script>
    <script type="text/javascript" src="/js/assets/js/realm.js"></script>
    <script type="text/javascript" src="/js/assets/js/jquery.slimscroll.min.js"></script>
  </body>
</html>
