...
<div class="api_box clearfix">
	<div class="api_bread"><a href="index.ht">首页</a> &gt; <a href="ucAPI.ht">用户中心API</a> &gt; <a href="ucAPIIntro9.ht">子系统调用API</a> </div>
    <div class="api_left">
    	<h2>子系统调用API</h2>
        <ul>
        	<li class="active"><a href="javascript:void(0);">/api/getResById</a></li>
        </ul>
    </div>
   <div class="api_right">
      <div class="api_items" style="display:block;">
      		<div class="api_rightTit">/api/getResById</div>
      			<h6>根据资源ID获取资源详情</h6>
      			<div class="api_rightCon">
	        		...
	        		<p class="api_right_text api_right_style">/api/getResById.ht</p>
	       		 </div>
	      		<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
...
public class TestDemo{
	public static void main(String args[]) {
		String url = "http://aop.casicloud.com/api/getResById.ht";
...
"error":"请填写正确的参数"
      			...
      			<div class="api_rightCon">
	        		...
	        		<p class="api_right_text api_right_style">通过资源ID获取资源详情</p>
	       		 </div>
      			<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
