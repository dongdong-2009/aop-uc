...
<div class="api_box clearfix">
	<div class="api_bread"><a href="index.ht">首页</a> &gt; <a href="ucAPI.ht">用户中心API</a> &gt; <a href="ucAPIIntroduction11.ht">子系统调用API</a> </div>
    <div class="api_left">
    	<h2>子系统调用API</h2>
        <ul>
        	<li class="active"><a href="javascript:void(0);">/api/isAgetOrgInfoAndManagerByOrgId</a></li>
        </ul>
    </div>
   <div class="api_right">
      <div class="api_items" style="display:block;">
      		<div class="api_rightTit">/api/getOrgInfoAndManagerByOrgId</div>
      			<h6>子系统通过企业ID获得该企业的信息并返回该企业的一个管理员信息</h6>
      			<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
				       		 调用URL
			        </div>
	        		<p class="api_right_text api_right_style">/api/getOrgInfoAndManagerByOrgId.ht</p>
	       		 </div>
	      		<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
...
public class TestDemo{
	public static void main(String args[]) {
		String url = "http://aop.casicloud.com/api/getOrgInfoAndManagerByOrgId.ht";
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("systemId", 100);		
		Map<String, Object> data = new HashMap<String, Object>();
		data.put("orgId", "153495");	
...
"error":"企业不存在"
      			...
      			<div class="api_rightCon">
	        		...
	        		<p class="api_right_text api_right_style">子系统通过企业ID获得该企业的信息并返回该企业的一个管理员信息</p>
	       		 </div>
      			<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
	        		...
	        		<p class="api_right_text api_right_style">查询到的数据可以使用传递的参数值来从返回的数据中获得，若要获得管理员信息，请使用‘manager’作为key取值</p>
	       		 </div>
