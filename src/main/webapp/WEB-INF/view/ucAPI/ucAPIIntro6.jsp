...
<div class="api_box clearfix">
	<div class="api_bread"><a href="index.ht">首页</a> &gt; <a href="ucAPI.ht">用户中心API</a> &gt; <a href="ucAPIIntro6.ht">子系统调用API</a> </div>
    <div class="api_left">
    	<h2>子系统调用API</h2>
        <ul>
        	<li class="active"><a href="javascript:void(0);">/api/getRessByRole</a></li>
        </ul>
    </div>
   <div class="api_right">
      <div class="api_items" style="display:block;">
      		<div class="api_rightTit">/api/getRessByRole</div>
      			<h6>根据角色查询该角色下的所有的资源信息</h6>
      			<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
				       		 调用URL
			        </div>
	        		<p class="api_right_text api_right_style">/api/getRessByRole.ht</p>
	       		 </div>
	      		<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
...
public class TestDemo{
	public static void main(String args[]) {
		String url = "http://aop.casicloud.com/api/getRessByRole.ht";
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("systemId", 100);		
		Map<String, Object> data = new HashMap<String, Object>();
		data.put("roleId", "153495");	
...
"error":"未查询到该资源信息"
      			...
      			<div class="api_rightCon">
	        		...
	        		<p class="api_right_text api_right_style">根据角色Id查询该角色下的所有的资源信息</p>
	       		 </div>
      			<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
	        		...
	        		<p class="api_right_text api_right_style"></p>
	       		 </div>
