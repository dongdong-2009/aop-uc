...
<div class="api_box clearfix">
	<div class="api_bread"><a href="index.ht">首页</a> &gt; <a href="ucAPI.ht">用户中心API</a> &gt; <a href="ucAPIIntroduction5.ht">子系统调用API</a> </div>
    <div class="api_left">
    	<h2>子系统调用API</h2>
        <ul>
        	<li class="active"><a href="javascript:void(0);">/api/getUserInfoByOid</a></li>
        </ul>
    </div>
   <div class="api_right">
      <div class="api_items" style="display:block;">
      		<div class="api_rightTit">/api/getUserInfoByOid</div>
      			<h6>子系统通过用户的唯一标识来获取用户数据</h6>
      			<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
				       		 调用URL
			        </div>
	        		<p class="api_right_text api_right_style">/api/getUserInfoByOid</p>
	       		 </div>
	      		<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
...
public class TestDemo{
	public static void main(String args[]) {
		String url = "http://aop.casicloud.com/api/getUserInfoByOid.ht";
...
"error":"用户不存在"
      			...
      			<div class="api_rightCon">
	        		...
	        		<p class="api_right_text api_right_style">子系统通过用户的唯一标识来获取用户数据</p>
	       		 </div>
      			<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
