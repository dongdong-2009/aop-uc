...
<div class="api_box clearfix">
	<div class="api_bread"><a href="index.ht">首页</a> &gt; <a href="ucAPI.ht">用户中心API</a> &gt; <a href="ucAPIIntroduction9.ht">子系统调用API</a> </div>
    <div class="api_left">
    	<h2>子系统调用API</h2>
        <ul>
        	<li class="active"><a href="javascript:void(0);">/api/isAdmin</a></li>
        </ul>
    </div>
   <div class="api_right">
      <div class="api_items" style="display:block;">
      		<div class="api_rightTit">/api/isAdmin</div>
      			<h6>子系统通过用户ID判断此用户是否是管理员</h6>
      			<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
				       		 调用URL
			        </div>
	        		<p class="api_right_text api_right_style">/api/isAdmin</p>
	       		 </div>
	      		<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
...
public class TestDemo{
	public static void main(String args[]) {
		String url = "http://aop.casicloud.com/api/isAdmin.ht";
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("systemId", 100);		
		Map<String, Object> data = new HashMap<String, Object>();
		data.put("userId", "153495");	
...
"error":"此用户不是管理员"
      			...
      			<div class="api_rightCon">
	        		...
	        		<p class="api_right_text api_right_style">子系统通过用户ID判断此用户是否是管理员</p>
	       		 </div>
      			<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
	        		...
	        		<p class="api_right_text api_right_style">查询到的数据可以使用传递的参数值来从返回的数据中获得，此方法不能判断此用户是否属于该企业。</p>
	       		 </div>
