...
<div class="api_box clearfix">
	<div class="api_bread"><a href="index.ht">首页</a> &gt; <a href="ucAPI.ht">用户中心API</a> &gt; <a href="ucAPIIntro10.ht">子系统调用API</a> </div>
    <div class="api_left">
    	<h2>子系统调用API</h2>
        <ul>
        	<li class="active"><a href="javascript:void(0);">/api/isOpen</a></li>
        </ul>
    </div>
   <div class="api_right">
      <div class="api_items" style="display:block;">
      		<div class="api_rightTit">/api/isOpen</div>
      			<h6>资源禁用与启用</h6>
      			<div class="api_rightCon">
	        		...
	        		<p class="api_right_text api_right_style">/api/isOpen.ht</p>
	       		 </div>
	      		<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
...
public class TestDemo{
	public static void main(String args[]) {
		String url = "http://aop.casicloud.com/api/isOpen.ht";
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("systemId", 100);		
		Map<String, Object> data = new HashMap<String, Object>();
		data.put("resId", "153495");	
...
"error":"设置成功"
      			...
      			<div class="api_rightCon">
	        		...
	        		<p class="api_right_text api_right_style">资源的启用与禁用</p>
	       		 </div>
      			<div class="api_rightCon">
			        <div class="api_rightCon_tit">
				        <i class="triangle open"></i>
	        		...
	        		<p class="api_right_text api_right_style">isOpen设置为1，则启用资源，设置为0，则禁用资源</p>
	       		 </div>
