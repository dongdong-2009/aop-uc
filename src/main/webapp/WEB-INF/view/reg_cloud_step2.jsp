...
<body>
 <%@ include file="/commons/regTop.jsp" %>
        <div class="register2">
            <div class="register2_outer">
                ...
                <input type="hidden" id="user" value="${user}"/>
                 ...
                 <input type="hidden"  name="invititedCode" value="${invititedCode}"/>
                 <input type="hidden"  name="relMes" id="relMes"/>
                 ...
                 <input type="hidden" name="mark" value="1" />
                    <div class="register2_list">
                        ...
                        <input type="text" class="register2_list_right" placeholder="请输入会员用户名" name="account" id="account"/>
                        <font color="red"></font>
                    </div>
                    <div class="register2_list">
                        <div class="register2_list_left">
                    ...
                    <div class="register2_list">
                     ...
                     <div class="register2_list">
                        ...
                        <input type="text" class="register2_list_right" placeholder="请输入公司名称" name="name" id="name" onfocus="checkFocusName(this);addStyle(this);" onblur="checkBlurName()" oninput="appendSome(this)" />
                        <font color="red"></font>
                         <div class="selbox">
                           <ul>
                              <li data-val="大" >大有限公司</li>
                              <li data-val="大">大(个体经营)</li>
                              <li data-val="大">大集团</li>
                              <li data-val="大">大有限责任公司</li>
                           </ul>
                         </div>
                    </div>
                    <div class="register2_list">
                        ...
                        <input type="text" class="register2_list_right" placeholder="请输入联系人" name="connecter" id="connecter" onfocus="checkFocusConnctor(this);"   onblur="checkBlurConnector();"/>
                        <font color="red"></font>
                    </div>
                    ...
                    <div class="register2_list">
                        ...
                        <input type="button" class="register2_list_btn" value="立即注册" onclick="save();" id="btn"/>
                    </div>
                </form>
