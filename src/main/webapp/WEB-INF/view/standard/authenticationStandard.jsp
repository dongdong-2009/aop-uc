...
$(function(){
	 ...
	 if(type=="1"){
		 ...
		 $("#res_content").attr("src","${ctx}/authenticationStandardAdd.ht");
		 $("#authenticationStandardAdd").addClass("active");
	 }else if(type=="2"){
		 $(".api_left ul li").each(function(){
       		$(this).removeClass("active");
		 });
		 $("#res_content").attr("src","${ctx}/authenticationStandardUpdate.ht");
		 $("#authenticationStandardUpdate").addClass("active");
		 
	 }else if(type=="3"){
		 $(".api_left ul li").each(function(){
       		$(this).removeClass("active");
	 	});
		 $("#res_content").attr("src","${ctx}/authenticationStandardDelete.ht");
		 $("#authenticationStandardDelete").addClass("active");
	 }
	...
	function getURL(name){
        	if(name=="增加"){
        		return "${ctx}/authenticationStandardAdd.ht";
        	}else if(name=="修改"){
        		return "${ctx}/authenticationStandardUpdate.ht";
        	}else if(name=="删除"){
        		return '${ctx}/authenticationStandardDelete.ht';
        	}
        }
    ...
    <div class="gWidth">
        <div class="aopIndex_nav_c clearfix">
            <ul class="f_left aopIndex_nav_l">
                <li><a href="aopIndex.html">首页</a></li>
...
<div class="api_box clearfix">
	<div class="api_bread"><a href="index.ht">首页</a> &gt; <a href="joinStandard.ht">接入规范</a> &gt; <a href="authenticationStandard.ht">认证规范</a> </div>
    <div class="api_left">
    	<h2>认证规范</h2>
        <ul>
        	<li id="authenticationStandardAdd" class="active"><a href="javascript:void(0);">增加</a></li>
            <li id="authenticationStandardUpdate"><a href="javascript:void(0);">修改</a></li>
            <li id="authenticationStandardDelete"><a href="javascript:void(0);">删除</a></li>
        </ul>
    </div>
   <div class="api_right" style="overflow:hidden;">
       <iframe src="/authenticationStandardAdd.ht" frameborder="0" scrolling="no" width="100%" style="height: 1100px;" id="res_content"></iframe>
    </div>
</div>
