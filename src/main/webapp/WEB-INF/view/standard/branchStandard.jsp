...
$(function(){
	 ...
	 if(type=="1"){
		 ...
		 $("#res_content").attr("src","${ctx}/branchStandardAdd.ht");
		 $("#branchStandardAdd").addClass("active");
	 }else if(type=="2"){
		 $(".api_left ul li").each(function(){
       		$(this).removeClass("active");
		 });
		 $("#res_content").attr("src","${ctx}/branchStandardUpdate.ht");
		 $("#branchStandardUpdate").addClass("active");
		 
	 }else if(type=="3"){
		 $(".api_left ul li").each(function(){
       		$(this).removeClass("active");
	 	});
		 $("#res_content").attr("src","${ctx}/branchStandardDelete.ht");
		 $("#branchStandardDelete").addClass("active");
	 }
	...
	function getURL(name){
        	if(name=="增加"){
        		return "${ctx}/branchStandardAdd.ht";
        	}else if(name=="修改"){
        		return "${ctx}/branchStandardUpdate.ht";
        	}else if(name=="删除"){
        		return '${ctx}/branchStandardDelete.ht';
        	}
        }
...
<div class="api_box clearfix">
	<div class="api_bread"><a href="index.ht">首页</a> &gt; <a href="joinStandard.ht">接入规范</a> &gt; <a href="branchStandard.ht">开户规范</a> </div>
    <div class="api_left">
    	<h2>开户规范</h2>
        <ul>
        	<li id="branchStandardAdd" class="active"><a href="javascript:void(0);">增加</a></li>
            <li id="branchStandardUpdate"><a href="javascript:void(0);">修改</a></li>
            <!-- <li id="branchStandardDelete"><a href="javascript:void(0);">删除</a></li> -->
        </ul>
    </div>
   <div class="api_right" style="overflow:hidden;">
       <iframe src="/branchStandardAdd.ht" frameborder="0" scrolling="no" width="100%" style="height: 1100px;" id="res_content"></iframe>
    </div>
</div>
