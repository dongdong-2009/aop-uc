		...
		**/
		...
		function load_Org_Tree(){
			...
			var setting = {
					...
					async: {
						enable: true,
						url:"${ctx}/platform/system/sysOrg/getTreeDataByCompany.ht?demId="+value+'&companyId='+companyId,
...
<body>
	<div id="defLayout">
		...
		<div position="center">
			...
			<iframe id="userListFrame" name="userListFrame" height="90%" width="100%" frameborder="0" src="${ctx}/platform/system/sysUser/selectorCompany.ht?isSingle=${isSingle}&companyId=${companyId}"></iframe>
		</div>
