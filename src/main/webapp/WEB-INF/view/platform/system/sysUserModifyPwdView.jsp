	...
	<script type="text/javascript">
		$(function() {
			function showRequest(formData, jqForm, options) {
				...
				var primitivePassword = $("#primitivePassword").val();
				if(newPassword == primitivePassword){
			...
			function showResponse(responseText, statusText)  { 
				...
				if(obj.isSuccess()){//成功
					$.ligerMessageBox.success('提示信息',"密码修改成功，请重新登陆",function(){
						window.parent.location.href="${ctx}/CAS/casLogout.ht";
					});		
			    }else{//失败
					...
					<div class="panel-detail">
						<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td>${sysUser.account}<input type="password" style="width:0px;height:0px;background-color:transparent;border:none;"/></td>
							</tr>
							<tr>
