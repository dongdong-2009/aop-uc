		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group">
						<f:a alias="addUnder" css="link add"  href="javascript:add();">添加</f:a>
					</div>
					<div class="l-bar-separator"></div>
					<div class="group"><a class="link del"  action="del.ht">删除</a></div>
					<c:if test="${showMyleader}"><div class="group"><a class="link primary" >我的上级</a></div></c:if>
				</div>	
			</div>
			<div class="panel-search">
					<form id="searchForm" method="post" action="list.ht">
							<div class="row">									
								<span class="label">下属用户名:</span><input type="text" name="Q_underusername_SL"  class="inputText" value="${param['Q_underusername_SL']}"/>											
							</div>
					</form>
			</div>
		</div>
