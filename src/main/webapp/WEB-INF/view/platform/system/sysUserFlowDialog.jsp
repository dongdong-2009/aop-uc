		...
		function load_Rol_Tree(){
			...
			$(function(){
				if ((navigator.userAgent.indexOf('MSIE') >= 0) 
					    ...
					    if($("#SEARCH_BY_ORG_1_a")){
							$("#userListFrame").attr("src","${ctx}/platform/system/sysUser/selector.ht?isSingle=${isSingle}");
					    }
				}
			})
			function closeWin(){
...
<body>
	<div id="defLayout">
		...
		<div position="bottom"  class="bottom" >
			...
			<a href="#" class="button" style="margin-left:10px;"  onclick="closeWin();"><span class="icon cancel"></span><span >取消</span></a>
		</div>
	</div>
</body>
</html>
