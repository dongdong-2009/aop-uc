...
<div class="MainBox">
 ...
 <form method="post" action="" class="formgroup" id="address_form">
    ...
    <input type="hidden" id="isReceviced" name="isReceviced" value="${address.isReceviced}">
    ...
    <div class="formgroup clearfix">
      ...
      <div class="input-text"> <input type="text" name="contact" id="contact" class="i-text" value="${address.contact}"/><font color="red"></font></div>
    </div>
    <div class="formgroup clearfix">
    ...
    <div class="formgroup clearfix">
      ...
      <div class="input-text"><textarea  name="addresDetail" id="addresDetail" class="i-text" style="height:65px;width:300px;">${address.addresDetail}</textarea><font color="red"></font></div>
    </div>
    <div class="formgroup clearfix">
      <div class="label-text"><span class="red">*</span>邮政编码：</div>
      <div class="input-text"> <input type="text" name="postcode" id="postcode" class="i-text" value="${address.postcode}"/><font color="red"></font></div>
    </div>
    <div class="formgroup clearfix">
      <div class="label-text">电话：</div>
      <div class="input-text"> <input type="text" name="mobile" id="mobile" class="i-text" value="${address.mobile}"/><font color="red"></font></div>
    </div>
    <div class="formgroup clearfix">
      <div class="label-text"><span class="red">*</span>手机号码：</div>
      <div class="input-text"> <input type="text" name="telephone" id="telephone" class="i-text" value="${address.telephone}"/><font color="red"></font></div>
    </div>
    <div class="formgroup clearfix">
     ...
     <div class="formgroup clearfix">
      ...
      <span  class="egister_mainCon_btn"  style="width: 100px;" onclick="submit()"> <input type="button" value="提交" class="egister_mainCon_btn" ></span>
