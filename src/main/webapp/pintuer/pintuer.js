$(function(){
	...
	$pintuercheck=function(element,type,value){
		...
		switch(type){
			...
			case "mobile":return /^((\(\d{3}\))|(\d{3}\-))?1[0-9][0-9]\d{8}?$|15[89]\d{8}?$|170\d{8}?$|147\d{8}?$/.test($pintu);break;
			...
			case "emailOrmobile":return /^(((\(\d{3}\))|(\d{3}\-))?1[0-9][0-9]\d{8}?$|15[89]\d{8}?$|170\d{8}?$|147\d{8}?)|([^@]+@[^@]+\.[^@]+)$/.test($pintu);break;
			case "radio":
				...
				if($test.length>1){
					switch($test[0]){
						...
						case "ajax":
							...
							break;
						case "repeat":
							var a = jQuery('input[name="'+$test[1]+'"]').eq(0).val();
							if(jQuery('input[name="'+$test[1]+'"]').eq(0).val()==null || jQuery('input[name="'+$test[1]+'"]').eq(0).val()=="" || jQuery('input[name="'+$test[1]+'"]').eq(0).val()==undefined){
								jQuery('input[name="'+$test[1]+'"]').eq(0).focus();
								jQuery('input[name="'+$test[1]+'"]').eq(0).blur();
								return false;
							}
						...
						case "anotherRepeat":
							...
							if(jQuery('input[name="'+$test[1]+'"]').eq(0).val()==null || jQuery('input[name="'+$test[1]+'"]').eq(0).val()=="" || jQuery('input[name="'+$test[1]+'"]').eq(0).val()==undefined){
								...
								if($pintu==jQuery('input[name="'+$test[1]+'"]').eq(0).val()){
									jQuery('input[name="'+$test[1]+'"]').eq(0).focus();
									jQuery('input[name="'+$test[1]+'"]').eq(0).blur();
									return true;
								}else{
